...
def main(args):
    ...
    if args.for_mcmc:
        ...
        filepath = args.singletask_file
        f = h5.File(filepath, 'r')

        data_ind = np.random.randint(0, len(f['z']))
        z = f['z'][data_ind]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--singletask_file', type=str, default='spectra_data/60tasks_2000samples_seed456.h5')
    parser.add_argument('--fiducial_file', type=str, default='spectra_data/CS_sacc_fiducial_data.sacc')
