...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrain_file', type=str, default='data/42_dndz_nsamples=30000.h5', help='Path to pretraining data')
    parser.add_argument('--finetune_file', type=str, default='data/mcmc_dndz_nsamples=30000.h5', help='Path to finetuning data')
