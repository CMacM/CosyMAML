...
python3 /home/cmacmahon/glljobstat.py -i 10 -f $SLURM_JOB_ID -fm -r > /home/cmacmahon/CosyMAML/logs/io/MAML_pipe_log_${SLURM_JOB_ID}_rate.log &
PID1=$!

# -f filters job, -fm tells glljobstat to only include this job
python3 /home/cmacmahon/glljobstat.py -i 10 -f $SLURM_JOB_ID -fm -hi > /home/cmacmahon/CosyMAML/logs/io/MAML_pipe_log_${SLURM_JOB_ID}_hist.log &
PID2=$!
