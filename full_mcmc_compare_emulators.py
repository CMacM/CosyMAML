...
def main(args):
    ...
    pretrain_backend = f'mcmc/{nwalkers}_pretrain_emulator_mcmc_{args.tau_factor}tau.h5'
    ...
    # Define backend file for emcee
    fresh_backend = f'mcmc/{nwalkers}_fresh_emulator_mcmc_{args.tau_factor}tau.h5'
    ...
    # Define backend file for emcee
    maml_backend = f'mcmc/{nwalkers}_maml_emulator_mcmc_{args.tau_factor}tau.h5'
