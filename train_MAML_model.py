...
def main(args):
    ...
    with torch.profiler.profile(
        ...
        on_trace_ready=torch.profiler.tensorboard_trace_handler('./torchlogs'),
        record_shapes=True,
        profile_memory=True,
        with_stack=True
    ) as prof:
