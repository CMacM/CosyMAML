...
def main(args):
    ...
    for i in range(args.n_tasks):
        ...
        ells = np.geomspace(10, args.ell_max, args.ell_bins)
        arglist = [
        ...
        print('Computing spectra for task {}...'.format(i+1))
        print('N(z) parameters: {}'.format(kwargs))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', type=str, default='spectra_data', help='Output directory')
